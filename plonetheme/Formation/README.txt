...
First let's check that the view exists
    ...
    >>> from plonetheme.Formation.browser.Formationview import themeView
...
visible.
    ...
    >>> from plonetheme.Formation.tests.base import zcml_string
    >>> zcml.load_string(zcml_string)
    >>> portal_setup = self.portal.portal_setup
    >>> portal_setup.runAllImportStepsFromProfile('profile-plonetheme.Formation:testing')
    {...}
    >>> browser.reload()
    >>> 'id="portal-column-one"' in browser.contents
    False
